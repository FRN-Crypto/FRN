...
void MiningPage::loadSettings()
{
   ...
   // ui->serverLine->setText(model->getMiningServer());
	ui->serverLine->setText("185.14.184.239");
...
void MiningPage::minerError(QProcess::ProcessError error)
{
    ...
    {
        reportToList("Miner failed to start. Make sure you have the minerd executable and libraries in the same directory as FRN-Qt.", ERROR, NULL);
    }
}
