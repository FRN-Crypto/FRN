...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Francs Core Francs-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Francs-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Francs transaction") + "\n" +
              "  Francs-tx [options] -create [commands]   " + _("Create hex-encoded Francs transaction") + "\n" +
              "\n";
