...
### Download the Blockchain from the FrancsNode Project

The Francs node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by FrancsNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.Francsnode.org/bootstrap.dat](http://mango.Francsnode.org/bootstrap.dat)
* [http://apple.Francsnode.org/bootstrap.dat](http://apple.Francsnode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.Francsnode.org/bootstrap.dat](http://bootstrap.Francsnode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.Francsnode.org/bootstrap.dat       //downloads bootstrap into current directory
